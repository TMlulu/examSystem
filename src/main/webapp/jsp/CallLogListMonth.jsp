...
<div id="container1" style="height: 80%; width: 40%; margin-left: 100px; float:left"></div>
<div id="container2" style="height: 80%; width: 40%; margin-right: 50px; float:right"></div>
